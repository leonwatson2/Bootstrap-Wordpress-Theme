...
(function($, window, document, undefined) {
    ...
    var Portfolio = {
        ...
        showContent: function(thumbnail) {
            ...
            self.$elem.find('li a.thumbnail .active-arrow').slideUp('normal', function(){ $(this).remove()});
            self.$elem.find('li.content').slideUp('normal', function(){ $(this).remove()});
            // Add active arrow
            ...
            self.$elem.find('.close').click(function(){
                self.$elem.find('li a.thumbnail .active-arrow').slideUp();
